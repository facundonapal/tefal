...
!function(t) {
    ...
    i.prototype.close = function(e) {
        ...
        n = t(o),
        e && e.preventDefault(),
        n.length || (n = s.hasClass("alert") ? s : s.parent()),
        n.trigger(e = t.Event("close")),
        e.isDefaultPrevented() || (n.removeClass("in"),
        t.support.transition && n.hasClass("fade") ? n.on(t.support.transition.end, i) : i())
    }
    ;
    var n = t.fn.alert;
    ...
    t.fn.button = function(i) {
        return this.each(function() {
            var n = t(this)
              , s = n.data("button")
              , o = "object" == typeof i && i;
            s || n.data("button", s = new e(this,o)),
...
!function(t) {
    ...
    e.prototype = {
        ...
        slide: function(e, i) {
            ...
            if (this.sliding = !0,
            a && this.pause(),
            o = o.length ? o : this.$element.find(".item")[h](),
            n = t.Event("slide", {
                relatedTarget: o[0],
                direction: r
            }),
    ...
    t.fn.carousel = function(i) {
        return this.each(function() {
            ...
            s || n.data("carousel", s = new e(this,o)),
            "number" == typeof i ? s.to(i) : a ? s[a]() : o.interval && s.pause().cycle()
        })
    }
    ,
    ...
    t(document).on("click.carousel.data-api", "[data-slide], [data-slide-to]", function(e) {
        ...
        o.carousel(a),
        (n = s.attr("data-slide-to")) && o.data("carousel").pause().to(n).cycle(),
        e.preventDefault()
    })
}(window.jQuery),
!function(t) {
    ...
    t.fn.collapse = function(i) {
        return this.each(function() {
            ...
            s || n.data("collapse", s = new e(this,o)),
            "string" == typeof i && s[i]()
        })
    }
    ,
    ...
    t(document).on("click.collapse.data-api", "[data-toggle=collapse]", function(e) {
        ...
        n[t(s).hasClass("in") ? "addClass" : "removeClass"]("collapsed"),
        t(s).collapse(o)
    })
}(window.jQuery),
!function(t) {
    ...
    s.prototype = {
        ...
        keydown: function(e) {
            var s, o, a, r, h;
            if (/(38|40|27)/.test(e.keyCode) && (s = t(this),
            e.preventDefault(),
            e.stopPropagation(),
            !s.is(".disabled, :disabled"))) {
                ...
                o.length && (h = o.index(o.filter(":focus")),
                38 == e.keyCode && h > 0 && h--,
                40 == e.keyCode && h < o.length - 1 && h++,
                ~h || (h = 0),
                o.eq(h).focus())
            }
        }
...
!function(t) {
    ...
    t.fn.modal = function(i) {
        return this.each(function() {
            ...
            s || n.data("modal", s = new e(this,o)),
            "string" == typeof i ? s[i]() : o.show && s.show()
        })
    }
    ,
    t.fn.modal.defaults = {
...
!function(t) {
    ...
    e.prototype = {
        ...
        init: function(e, i, n) {
            ...
            h = a.length; h--; )
                r = a[h],
                "click" == r ? this.$element.on("click." + this.type, this.options.selector, t.proxy(this.toggle, this)) : "manual" != r && (s = "hover" == r ? "mouseenter" : "focus",
                o = "hover" == r ? "mouseleave" : "blur",
        ...
        enter: function(e) {
            ...
            i = t(e.currentTarget)[this.type](s).data(this.type),
            i.options.delay && i.options.delay.show ? (clearTimeout(this.timeout),
            i.hoverState = "in",
        ...
        applyPlacement: function(t, e) {
            ...
            i = a[0].offsetWidth,
            n = a[0].offsetHeight),
            this.replaceArrow(s - r + i, i, "left")) : this.replaceArrow(n - h, n, "top"),
            o && a.offset(t)
        },
        ...
        hide: function() {
            ...
            !n.isDefaultPrevented())
                ...
                t.support.transition && this.$tip.hasClass("fade") ? e() : i.detach(),
    ...
    t.fn.popover = function(i) {
        return this.each(function() {
            var n = t(this)
              , s = n.data("popover")
              , o = "object" == typeof i && i;
            s || n.data("popover", s = new e(this,o)),
            "string" == typeof i && s[i]()
        })
    }
    ,
...
!function(t) {
    ...
    function e(e, i) {
        ...
        this.$scrollElement = o.on("scroll.scroll-spy.data-api", s),
    ...
    e.prototype = {
        ...
        process: function() {
            ...
            for (t = s.length; t--; )
                a != o[t] && e >= s[t] && (!s[t + 1] || e <= s[t + 1]) && this.activate(o[t])
        },
        activate: function(e) {
            var i, n;
            this.activeTarget = e,
    ...
    t.fn.scrollspy = function(i) {
        return this.each(function() {
            var n = t(this)
              , s = n.data("scrollspy")
              , o = "object" == typeof i && i;
            s || n.data("scrollspy", s = new e(this,o)),
            "string" == typeof i && s[i]()
        })
    }
    ,
...
!function(t) {
    ...
    e.prototype = {
        ...
        show: function() {
            ...
            a || (a = s.attr("href"),
            a = a && a.replace(/.*(?=#[^\s]*$)/, "")),
            s.parent("li").hasClass("active") || (e = o.find(".active:last a")[0],
            n = t.Event("show", {
                relatedTarget: e
            }),
            s.trigger(n),
            n.isDefaultPrevented() || (i = t(a),
            this.activate(s.parent("li"), o),
        ...
        activate: function(e, i, n) {
            ...
            a ? o.one(t.support.transition.end, s) : s(),
            o.removeClass("in")
        }
    };
    var i = t.fn.tab;
...
!function(t) {
    ...
    e.prototype = {
        ...
        sorter: function(t) {
            for (var e, i = [], n = [], s = []; e = t.shift(); )
                e.toLowerCase().indexOf(this.query.toLowerCase()) ? ~e.indexOf(this.query) ? n.push(e) : s.push(e) : i.push(e);
            return i.concat(n, s)
        },
        ...
        render: function(e) {
            ...
            return e = t(e).map(function(e, n) {
                return e = t(i.options.item).attr("data-value", n),
    ...
    t.fn.typeahead = function(i) {
        return this.each(function() {
            var n = t(this)
              , s = n.data("typeahead")
              , o = "object" == typeof i && i;
            s || n.data("typeahead", s = new e(this,o)),
            "string" == typeof i && s[i]()
        })
    }
    ,
...
!function(t) {
    ...
    e.prototype.checkPosition = function() {
        if (this.$element.is(":visible")) {
            ...
            "object" != typeof o && (a = r = o),
            "function" == typeof r && (r = o.top()),
            "function" == typeof a && (a = o.bottom()),
            e = !(null != this.unpin && n + this.unpin <= s.top) && (null != a && s.top + this.$element.height() >= i - a ? "bottom" : null != r && n <= r && "top"),
            this.affixed !== e && (this.affixed = e,
            this.unpin = "bottom" == e ? s.top - n : null,
