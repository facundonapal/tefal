!function(e, t) {
    ...
    function i(e, n, r, i) {
        if (ce.acceptData(e)) {
            ...
            if (c && u[c] && (i || u[c].data) || r !== t || "string" != typeof n)
                return c || (c = l ? e[s] = te.pop() || ce.guid++ : s),
                u[c] || (u[c] = l ? {} : {
                    toJSON: ce.noop
                }),
    ...
    function o(e, t, n) {
        if (ce.acceptData(e)) {
            ...
            if (a[l]) {
                ...
                (n || (delete a[l].data,
                s(a[l]))) && (o ? ce.cleanData([e], !0) : ce.support.deleteExpando || a != a.window ? delete a[l] : a[l] = null)
            }
        }
    }
    function a(e, n, r) {
    ...
    function N(e, t) {
        for (var n, r, i, o = [], a = 0, s = e.length; s > a; a++)
            ...
            "" === r.style.display && C(r) && (o[a] = ce._data(r, "olddisplay", A(r.nodeName)))) : o[a] || (i = C(r),
    ...
    function E(e, t, n, r, i) {
        for (var o = n === (r ? "border" : "content") ? 4 : "width" === t ? 1 : 0, a = 0; 4 > o; o += 2)
            ...
            r ? ("content" === n && (a -= ce.css(e, "padding" + Ct[o], !0, i)),
            "margin" !== n && (a -= ce.css(e, "border" + Ct[o] + "Width", !0, i))) : (a += ce.css(e, "padding" + Ct[o], !0, i),
    ...
    function A(e) {
        var t = G
          , n = xt[e];
        return n || (n = j(e, t),
        "none" !== n && n || (ut = (ut || ce("<iframe frameborder='0' width='0' height='0'/>").css("cssText", "display:block !important")).appendTo(t.documentElement),
    ...
    function H(e, n, r, i) {
        function o(l) {
            ...
            ce.each(e[l] || [], function(e, l) {
                var c = l(n, r, i);
                return "string" != typeof c || s || a[c] ? s ? !(u = c) : t : (n.dataTypes.unshift(c),
                o(c),
                !1)
            }),
            u
    ...
    function R(e, t, n) {
        var r, i, o = 0, a = nn.length, s = ce.Deferred().always(function() {
            ...
            if (i)
                return !1;
            for (var t = Qt || B(), n = Math.max(0, u.startTime + u.duration - t), r = n / u.duration || 0, o = 1 - r, a = 0, l = u.tweens.length; l > a; a++)
                u.tweens[a].run(o);
    ...
    function $(e, t, n) {
        ...
        ce.support.shrinkWrapBlocks || u.always(function() {
    ...
    var U, V, Y = typeof t, J = e.location, G = e.document, Q = G.documentElement, K = e.jQuery, Z = e.$, ee = {}, te = [], ne = "1.10.2", re = te.concat, ie = te.push, oe = te.slice, ae = te.indexOf, se = ee.toString, le = ee.hasOwnProperty, ue = ne.trim, ce = function(e, t) {
        ...
        e.removeEventListener("load", Ce, !1)) : (G.detachEvent("onreadystatechange", Ce),
    ...
    ce.fn = ce.prototype = {
        ...
        init: function(e, n, r) {
            ...
            if ("string" == typeof e) {
                ...
                if (i[1]) {
                    if (n = n instanceof ce ? n[0] : n,
                    ce.merge(this, ce.parseHTML(i[1], n && n.nodeType ? n.ownerDocument || n : G, !0)),
                    ge.test(i[1]) && ce.isPlainObject(n))
                        for (i in n)
                            ce.isFunction(this[i]) ? this[i](n[i]) : this.attr(i, n[i]);
                    return this
                }
                if (o = G.getElementById(i[2]),
                o && o.parentNode) {
                    if (o.id !== i[2])
                        return r.find(e);
                    this.length = 1,
            ...
            this.length = 1,
            this) : ce.isFunction(e) ? r.ready(e) : (e.selector !== t && (this.selector = e.selector,
        ...
        --l); u > l; l++)
            if (null != (o = arguments[l]))
                for (i in o)
                    e = s[i],
                    r = o[i],
                    s !== r && (c && r && (ce.isPlainObject(r) || (n = ce.isArray(r))) ? (n ? (n = !1,
                    a = e && ce.isArray(e) ? e : []) : a = e && ce.isPlainObject(e) ? e : {},
    ...
    ce.extend({
        ...
        ready: function(e) {
            if (e === !0 ? !--ce.readyWait : !ce.isReady) {
                ...
                ce.isReady = !0,
                e !== !0 && --ce.readyWait > 0 || (U.resolveWith(G, [ce]),
        ...
        proxy: function(e, n) {
            ...
            n = e,
            e = o),
            ce.isFunction(e) ? (r = oe.call(arguments, 2),
            i = function() {
    ...
    ce.ready.promise = function(t) {
        if (!U)
            ...
            "complete" === G.readyState)
                ...
                G.attachEvent("onreadystatechange", Ce),
    ...
    function(e, t) {
            ...
            if (_ && !r) {
                ...
                if (C.qsa && (!M || !M.test(e))) {
                    ...
                    1 === s && "object" !== t.nodeName.toLowerCase()) {
                        for (u = p(e),
                        (c = t.getAttribute("id")) ? f = c.replace(we, "\\$&") : t.setAttribute("id", f),
                        f = "[id='" + f + "'] ",
                        l = u.length; l--; )
                            u[l] = f + d(u[l]);
        ...
        function p(e, t) {
            ...
            u = k.preFilter; s; ) {
                ...
                s = s.slice(r.length));
                for (a in k.filter)
                    !(i = ye[a].exec(s)) || u[a] && !(i = u[a](i)) || (r = i.shift(),
                    o.push({
                        value: r,
                        type: a,
                        matches: i
        ...
        function y(e, t, n, r, o, a) {
            ...
            o && !o[P] && (o = y(o, a)),
            i(function(i, a, s, l) {
                var u, c, f, p = [], d = [], h = a.length, g = i || x(t || "*", s.nodeType ? [s] : s, []), y = !e || !i && t ? g : m(g, p, e, s, l), v = n ? o || (i ? e : h || r) ? [] : a : y;
                if (n && n(y, v, s, l),
                r)
                    for (u = m(v, d),
                    r(u, [], s, l),
                ...
                if (i) {
                    if (o || e) {
                        ...
                        for (c = v.length; c--; )
                            (f = v[c]) && (u = o ? ne.call(i, f) : p[c]) > -1 && (i[u] = !(a[u] = f))
                    }
                } else
                    v = m(v === a ? v.splice(h, v.length) : v),
        ...
        function T(e, t, n, r) {
            ...
            if (!r && 1 === u.length) {
                ...
                o.length > 2 && "ID" === (a = o[0]).type && C.getById && 9 === t.nodeType && _ && k.relative[o[1].type]) {
                    if (t = (k.find.ID(a.matches[0].replace(Ce, Ne), t) || [])[0],
                    !t)
                        return n;
                    e = e.slice(o.shift().value.length)
                }
                for (i = ye.needsContext.test(e) ? 0 : o.length; i-- && (a = o[i],
                !k.relative[s = a.type]); )
            ...
            return A(e, u)(r, t, !_, n, de.test(e)),
            n
        }
        ...
        , re = "checked|selected|async|autofocus|autoplay|controls|defer|disabled|hidden|ismap|loop|multiple|open|readonly|required|scoped", ie = "[\\x20\\t\\r\\n\\f]", oe = "(?:\\\\.|[\\w-]|[^\\x00-\\xa0])+", ae = oe.replace("w", "w#"), se = "\\[" + ie + "*(" + oe + ")" + ie + "*(?:([*^$|!~]?=)" + ie + "*(?:(['\"])((?:\\\\.|[^\\\\])*?)\\3|(" + ae + ")|)|)" + ie + "*\\]", le = ":(" + oe + ")(?:\\(((['\"])((?:\\\\.|[^\\\\])*?)\\3|((?:\\\\.|[^\\\\()[\\]]|" + se.replace(3, 8) + ")*)|.*)\\)|)", ue = RegExp("^" + ie + "+|((?:^|[^\\\\])(?:\\\\.)*)" + ie + "+$", "g"), fe = RegExp("^" + ie + "*," + ie + "*"), pe = RegExp("^" + ie + "*([>+~]|" + ie + ")" + ie + "*"), de = RegExp(ie + "*[+~]"), he = RegExp("=" + ie + "*([^\\]'\"]*)" + ie + "*\\]", "g"), ge = RegExp(le), me = RegExp("^" + ae + "$"), ye = {
            ID: RegExp("^#(" + oe + ")"),
            CLASS: RegExp("^\\.(" + oe + ")"),
        ...
        L = n.setDocument = function(e) {
            ...
            (C.qsa = ve.test(n.querySelectorAll)) && (o(function(e) {
                ...
                e.querySelectorAll("[selected]").length || M.push("\\[" + ie + "*(?:value|" + re + ")"),
            ...
            o(function(e) {
                ...
                e.querySelectorAll("[t^='']").length && M.push("[*^$]=" + ie + "*(?:''|\"\")"),
            ...
            B = ve.test(q.contains) || q.compareDocumentPosition ? function(e, t) {
            ...
            : function(e, t) {
                ...
                if (e === t)
                    ...
                    0;
                if (!o || !a)
                    return e === n ? -1 : t === n ? 1 : o ? -1 : a ? 1 : D ? ne.call(D, e) - ne.call(D, t) : 0;
                if (o === a)
                    return s(e, t);
            ...
            filter: {
                ...
                ATTR: function(e, t, r) {
                    return function(i) {
                        var o = n.attr(i, e);
                        return null == o ? "!=" === t : !t || (o += "",
                        "=" === t ? o === r : "!=" === t ? o !== r : "^=" === t ? r && 0 === o.indexOf(r) : "*=" === t ? r && o.indexOf(r) > -1 : "$=" === t ? r && o.slice(-r.length) === r : "~=" === t ? (" " + o + " ").indexOf(r) > -1 : "|=" === t && (o === r || o.slice(0, r.length + 1) === r + "-"))
                    }
                },
                    ...
                    : function(t, n, l) {
                        ...
                        if (m) {
                            ...
                            a && v) {
                                ...
                                for (; (f = ++d && f && f[g] || (p = d = 0) || h.pop()) && ((s ? f.nodeName.toLowerCase() !== y : 1 !== f.nodeType) || !++p || (v && ((f[P] || (f[P] = {}))[e] = [W, p]),
                                f !== t)); )
                                    ;
                            return p -= i,
                            p === r || 0 === p % r && p / r >= 0
    ...
    ce.extend({
        ...
        when: function(e) {
            var t, n, r, i = 0, o = oe.call(arguments), a = o.length, s = 1 !== a || e && ce.isFunction(e.promise) ? a : 0, l = 1 === s ? e : ce.Deferred(), u = function(e, n, r) {
                return function(i) {
                    n[e] = this,
    ...
    ce.support = function(t) {
        ...
        ce(function() {
            ...
            typeof f.style.zoom !== Y && (f.innerHTML = "",
    ...
    ce.extend({
        queue: function(e, n, r) {
            ...
            i = ce._data(e, n),
            r && (!i || ce.isArray(r) ? i = ce._data(e, n, ce.makeArray(r)) : i.push(r)),
            i || []) : t
        },
    ...
    ce.fn.extend({
        ...
        addClass: function(e) {
            ...
            if (l)
                for (t = (e || "").match(pe) || []; s > a; a++)
                    if (n = this[a],
                    r = 1 === n.nodeType && (n.className ? (" " + n.className + " ").replace(De, " ") : " ")) {
                        for (o = 0; i = t[o++]; )
                            0 > r.indexOf(" " + i + " ") && (r += i + " ");
        ...
        toggleClass: function(e, t) {
            ...
            return "boolean" == typeof t && "string" === n ? t ? this.addClass(e) : this.removeClass(e) : ce.isFunction(e) ? this.each(function(n) {
                ...
                if ("string" === n)
                    ...
                    (n === Y || "boolean" === n) && (this.className && ce._data(this, "__className__", this.className),
        ...
        val: function(e) {
            var n, r, i, o = this[0];
            return arguments.length ? (i = ce.isFunction(e),
            ...
            })) : o ? (r = ce.valHooks[o.type] || ce.valHooks[o.nodeName.toLowerCase()],
    ...
    ce.extend({
            ...
            select: {
                get: function(e) {
                    for (var t, n, r = e.options, i = e.selectedIndex, o = "select-one" === e.type || 0 > i, a = o ? null : [], s = o ? i + 1 : r.length, l = 0 > i ? s : o ? i : 0; s > l; l++)
                        if (n = r[l],
                        !(!n.selected && l !== i || (ce.support.optDisabled ? n.disabled : null !== n.getAttribute("disabled")) || n.parentNode.disabled && ce.nodeName(n.parentNode, "optgroup"))) {
                            if (t = ce(n).val(),
                            o)
                                return t;
                            a.push(t)
        ...
        attr: function(e, n, r) {
            ...
            if (e && 3 !== a && 8 !== a && 2 !== a)
                return typeof e.getAttribute === Y ? ce.prop(e, n, r) : (1 === a && ce.isXMLDoc(e) || (n = n.toLowerCase(),
                i = ce.attrHooks[n] || (ce.expr.match.bool.test(n) ? je : Ae)),
                r === t ? i && "get"in i && null !== (o = i.get(e, n)) ? o : (o = ce.find.attr(e, n),
        ...
        removeAttr: function(e, t) {
            ...
            if (o && 1 === e.nodeType)
                for (; n = o[i++]; )
                    r = ce.propFix[n] || n,
                    ce.expr.match.bool.test(n) ? Oe && Me || !_e.test(n) ? e[r] = !1 : e[ce.camelCase("default-" + n)] = e[r] = !1 : ce.attr(e, n, ""),
    ...
    Oe && Me || (ce.attrHooks.value = {
        set: function(e, n, r) {
            return ce.nodeName(e, "input") ? (e.defaultValue = n,
            t) : Ae && Ae.set(e, n, r)
        }
    }),
    Me || (Ae = {
        ...
        add: function(e, n, r, i, o) {
            ...
            if (y) {
                ...
                l = n.length; l--; )
                    ...
                    (d = s[h]) || (d = s[h] = [],
                    d.delegateCount = 0,
                    c.setup && c.setup.call(e, i, g, f) !== !1 || (e.addEventListener ? e.addEventListener(h, f, !1) : e.attachEvent && e.attachEvent("on" + h, f))),
            ...
            if (m && (c = m.events)) {
                ...
                u = t.length; u--; )
                    ...
                    d) {
                        ...
                        l && !p.length && (f.teardown && f.teardown.call(e, h, m.handle) !== !1 || ce.removeEvent(e, d, m.handle),
                        delete c[d])
                    } else
                        for (d in c)
                            ce.event.remove(e, d + t[u], n, r, !0);
                ce.isEmptyObject(c) && (delete m.handle,
                ce._removeData(e, "events"))
            }
        },
        trigger: function(n, r, i, o) {
            var a, s, l, u, c, f, p, d = [i || G], h = le.call(n, "type") ? n.type : n, g = le.call(n, "namespace") ? n.namespace.split(".") : [];
            if (l = f = i = i || G,
            3 !== i.nodeType && 8 !== i.nodeType && !Re.test(h + ce.event.triggered) && (h.indexOf(".") >= 0 && (g = h.split("."),
            h = g.shift(),
            g.sort()),
            s = 0 > h.indexOf(":") && "on" + h,
            ...
            o || !c.trigger || c.trigger.apply(i, r) !== !1)) {
                if (!o && !c.noBubble && !ce.isWindow(i)) {
                    ...
                    Re.test(u + h) || (l = l.parentNode); l; l = l.parentNode)
                        d.push(l),
                        f = l;
                ...
                for (p = 0; (l = d[p++]) && !n.isPropagationStopped(); )
                    ...
                    a = (ce._data(l, "events") || {})[n.type] && ce._data(l, "handle"),
                    a && a.apply(l, r),
                    a = s && l[s],
                    a && ce.acceptData(l) && a.apply && a.apply(l, r) === !1 && n.preventDefault();
                if (n.type = h,
                !o && !n.isDefaultPrevented() && (!c._default || c._default.apply(d.pop(), r) === !1) && ce.acceptData(i) && s && i[h] && !ce.isWindow(i)) {
                    f = i[s],
                    f && (i[s] = null),
                ...
                for (; u != this; u = u.parentNode || this)
                    if (1 === u.nodeType && (u.disabled !== !0 || "click" !== e.type)) {
                        ...
                        a = 0; l > a; a++)
                            i = n[a],
                            r = i.selector + " ",
                            o[r] === t && (o[r] = i.needsContext ? ce(r, this).index(u) >= 0 : ce.find(r, this, null, [u]).length),
                            o[r] && o.push(i);
                        o.length && s.push({
                            elem: u,
                            handlers: o
    ...
    : function(e, t, n) {
        var r = "on" + t;
        e.detachEvent && (typeof e[r] === Y && (e[r] = null),
        e.detachEvent(r, n))
    }
    ,
    ...
    ce.support.submitBubbles || (ce.event.special.submit = {
        ...
        teardown: function() {
            return !ce.nodeName(this, "form") && (ce.event.remove(this, "._submit"),
            t)
        }
    }),
    ...
    ce.each({
        ...
        ce.fn[e] = function(n, r) {
            ...
            this.length > 1 && (Xe[e] || (i = ce.unique(i)),
            Ie.test(e) && (i = i.reverse())),
            this.pushStack(i)
        }
    }),
    ce.extend({
    ...
    ce.fn.extend({
        ...
        remove: function(e, t) {
            for (var n, r = e ? ce.filter(e, this) : this, i = 0; null != (n = r[i]); i++)
                ...
                n.parentNode && (t && ce.contains(n.ownerDocument, n) && y(x(n, "script")),
            ...
            return ce.access(this, function(e) {
                ...
                if (!("string" != typeof e || et.test(e) || !ce.support.htmlSerialize && Ye.test(e) || !ce.support.leadingWhitespace && Je.test(e) || at[(Qe.exec(e) || ["", ""])[1].toLowerCase()])) {
                    ...
                    try {
                        for (; i > r; r++)
                            n = this[r] || {},
                            1 === n.nodeType && (ce.cleanData(x(n, !1)),
                            n.innerHTML = e);
                        n = 0
                    } catch (e) {}
                }
        ...
        domManip: function(e, t, n) {
            ...
            if (c && (l = ce.buildFragment(e, this[0].ownerDocument, !1, !n && this),
            r = l.firstChild,
            1 === l.childNodes.length && (l = r),
            r)) {
                for (a = ce.map(x(l, "script"), g),
                o = a.length; c > u; u++)
                    i = l,
                    u !== p && (i = ce.clone(i, !0, !0),
                    o && ce.merge(a, x(i, "script"))),
                    t.call(this[u], i, u);
                if (o)
    ...
    ce.extend({
        clone: function(e, t, n) {
            ...
            if (ce.support.html5Clone || ce.isXMLDoc(e) || !Ye.test("<" + e.nodeName + ">") ? o = e.cloneNode(!0) : (lt.innerHTML = e.outerHTML,
            lt.removeChild(o = lt.firstChild)),
            !(ce.support.noCloneEvent && ce.support.noCloneChecked || 1 !== e.nodeType && 11 !== e.nodeType || ce.isXMLDoc(e)))
                for (r = x(o),
                s = x(e),
                a = 0; null != (i = s[a]); ++a)
                    r[a] && b(i, r[a]);
        ...
        buildFragment: function(e, t, n, r) {
            for (var i, o, a, s, l, u, c, f = e.length, p = d(t), h = [], g = 0; f > g; g++)
                ...
                o || 0 === o)
                    if ("object" === ce.type(o))
                        ...
                        !ce.support.tbody)
                            for (o = "table" !== l || Ke.test(o) ? "<table>" !== c[1] || Ke.test(o) ? 0 : s : s.firstChild,
            ...
            ce.support.appendChecked || ce.grep(x(h, "input"), T),
            g = 0; o = h[g++]; )
        ...
        cleanData: function(e, t) {
            for (var n, r, i, o, a = 0, s = ce.expando, l = ce.cache, u = ce.support.deleteExpando, c = ce.event.special; null != (n = e[a]); a++)
                ...
                o = i && l[i])) {
                    ...
                    l[i] && (delete l[i],
                    u ? delete n[s] : typeof n.removeAttribute !== Y ? n.removeAttribute(s) : n[s] = null,
                    te.push(i))
                }
        },
        _evalUrl: function(e) {
    ...
    var ut, ct, ft, pt = /alpha\([^)]*\)/i, dt = /opacity\s*=\s*([^)]*)/, ht = /^(top|right|bottom|left)$/, gt = /^(none|table(?!-c[ea]).+)/, mt = /^margin/, yt = RegExp("^(" + fe + ")(.*)$", "i"), vt = RegExp("^(" + fe + ")(?!px)[a-z%]+$", "i"), bt = RegExp("^([+-])=(" + fe + ")", "i"), xt = {
        BODY: "block"
    }, Tt = {
        position: "absolute",
        visibility: "hidden",
    ...
    ce.extend({
        ...
        style: function(e, n, r, i) {
            if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
                ...
                if (n = ce.cssProps[l] || (ce.cssProps[l] = w(u, l)),
                s = ce.cssHooks[n] || ce.cssHooks[l],
                r === t)
                    return s && "get"in s && (o = s.get(e, !1, i)) !== t ? o : u[n];
                if (a = typeof r,
                "string" === a && (o = bt.exec(r)) && (r = (o[1] + 1) * o[2] + parseFloat(ce.css(e, n)),
                a = "number"),
                !(null == r || "number" === a && isNaN(r) || ("number" !== a || ce.cssNumber[l] || (r += "px"),
                ce.support.clearCloneStyle || "" !== r || 0 !== n.indexOf("background") || (u[n] = "inherit"),
        ...
        css: function(e, n, r, i) {
            ...
            return n = ce.cssProps[l] || (ce.cssProps[l] = w(e.style, l)),
            s = ce.cssHooks[n] || ce.cssHooks[l],
            s && "get"in s && (a = s.get(e, !0, r)),
            a === t && (a = ft(e, n, i)),
            "normal" === a && n in wt && (a = wt[n]),
            "" === r || r ? (o = parseFloat(a),
            r === !0 || ce.isNumeric(o) ? o || 0 : a) : a
        }
    }),
    ...
    ft = function(e, n, r) {
        ...
        return s && ("" !== l || ce.contains(e.ownerDocument, e) || (l = ce.style(e, n)),
        vt.test(l) && mt.test(n) && (i = u.width,
        o = u.minWidth,
        a = u.maxWidth,
    ...
    ce.support.opacity || (ce.cssHooks.opacity = {
        ...
        set: function(e, t) {
            ...
            n.zoom = 1,
            (t >= 1 || "" === t) && "" === ce.trim(o.replace(pt, "")) && n.removeAttribute && (n.removeAttribute("filter"),
    ...
    ce(function() {
        ...
        !ce.support.pixelPosition && ce.fn.position && ce.each(["top", "left"], function(e, n) {
            ce.cssHooks[n] = {
                get: function(e, r) {
                    return r ? (r = ft(e, n),
                    vt.test(r) ? ce(e).position()[n] + "px" : r) : t
                }
            }
        })
    }),
    ...
    ce.param = function(e, n) {
        ...
        if (n === t && (n = ce.ajaxSettings && ce.ajaxSettings.traditional),
    ...
    ce.extend({
        ...
        ajax: function(e, n) {
            function r(e, n, r, i) {
                ...
                r && (b = _(p, w, r)),
                b = M(p, b, w, o),
                o ? (p.ifModified && (T = w.getResponseHeader("Last-Modified"),
                T && (ce.lastModified[a] = T),
            ...
            e = t),
            n = n || {};
            var i, o, a, s, l, u, c, f, p = ce.ajaxSetup({}, n), d = p.context || p, h = p.context && (d.nodeType || d.jquery) ? ce(d) : ce.event, g = ce.Deferred(), m = ce.Callbacks("once memory"), y = p.statusCode || {}, v = {}, b = {}, x = 0, T = "canceled", w = {
                readyState: 0,
            ...
            w.success = w.done,
            w.error = w.fail,
            p.url = ((e || p.url || Lt) + "").replace(_t, "").replace(Pt, Dt[1] + "//"),
            p.type = n.method || n.type || p.method || p.type,
            p.dataTypes = ce.trim(p.dataType || "*").toLowerCase().match(pe) || [""],
            null == p.crossDomain && (i = Rt.exec(p.url.toLowerCase()),
            p.crossDomain = !(!i || i[1] === Dt[1] && i[2] === Dt[2] && (i[3] || ("http:" === i[1] ? "80" : "443")) === (Dt[3] || ("http:" === Dt[1] ? "80" : "443")))),
            ...
            delete p.data),
            p.cache === !1 && (p.url = Mt.test(a) ? a.replace(Mt, "$1_=" + Ht++) : a + (qt.test(a) ? "&" : "?") + "_=" + Ht++)),
            p.ifModified && (ce.lastModified[a] && w.setRequestHeader("If-Modified-Since", ce.lastModified[a]),
            ce.etag[a] && w.setRequestHeader("If-None-Match", ce.etag[a])),
    ...
    ce.ajaxPrefilter("json jsonp", function(n, r, i) {
        ...
        return l || "jsonp" === n.dataTypes[0] ? (o = n.jsonpCallback = ce.isFunction(n.jsonpCallback) ? n.jsonpCallback() : n.jsonpCallback,
        l ? n[l] = n[l].replace(Ut, "$1" + o) : n.jsonp !== !1 && (n.url += (qt.test(n.url) ? "&" : "?") + n.jsonp + "=" + o),
        ...
        if (!n.crossDomain || ce.support.cors) {
            ...
            return {
                send: function(i, o) {
                    ...
                    r = function(e, i) {
                        ...
                        try {
                            if (r && (i || 4 === l.readyState))
                                if (r = t,
                                a && (l.onreadystatechange = ce.noop,
                                Gt && delete Vt[a]),
                                i)
                    ...
                    ,
                    n.async ? 4 === l.readyState ? setTimeout(r) : (a = ++Jt,
                    Gt && (Vt || (Vt = {},
                    ce(e).unload(Gt)),
                    Vt[a] = r),
    ...
    var Qt, Kt, Zt = /^(?:toggle|show|hide)$/, en = RegExp("^(?:([+-])=|)(" + fe + ")([a-z%]*)$", "i"), tn = /queueHooks$/, nn = [$], rn = {
        "*": [function(e, t) {
    ...
    ce.fn.offset = function(e) {
        ...
        ce.contains(n, o) ? (typeof o.getBoundingClientRect !== Y && (i = o.getBoundingClientRect()),
        r = X(a),
        {
    ...
    "object" == typeof module && module && "object" == typeof module.exports ? module.exports = ce : (e.jQuery = e.$ = ce,
