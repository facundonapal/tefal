!function(e) {
    ...
    var a = {
        init: function(t) {
            var r = this;
            return r.data("jqv") && null != r.data("jqv") || (t = a._saveOptions(r, t),
        ...
        attach: function(t) {
            var r, i = this;
            return r = t ? a._saveOptions(i, t) : i.data("jqv"),
            r.validateAttribute = i.find("[data-validation-engine*=validate]").length ? "data-validation-engine" : "class",
            r.binded && (i.on(r.validationEventTrigger, "[" + r.validateAttribute + "*=validate]:not([type=checkbox]):not([type=radio]):not(.datepicker)", a._onFieldEvent),
            i.on("click", "[" + r.validateAttribute + "*=validate][type=checkbox],[" + r.validateAttribute + "*=validate][type=radio]", a._onFieldEvent),
            ...
            i.on("click", "a[data-validation-engine-skip], a[class*='validate-skip'], button[data-validation-engine-skip], button[class*='validate-skip'], input[data-validation-engine-skip], input[class*='validate-skip']", a._submitButtonClick),
            i.removeData("jqv_submitButton"),
            i.on("submit", a._onSubmitEvent),
            this
        },
        detach: function() {
            var t = this
              , r = t.data("jqv");
            return t.find("[" + r.validateAttribute + "*=validate]").not("[type=checkbox]").off(r.validationEventTrigger, a._onFieldEvent),
            t.find("[" + r.validateAttribute + "*=validate][type=checkbox],[class*=validate][type=radio]").off("click", a._onFieldEvent),
            t.off("submit", a._onSubmitEvent),
            t.removeData("jqv"),
            t.off("click", "a[data-validation-engine-skip], a[class*='validate-skip'], button[data-validation-engine-skip], button[class*='validate-skip'], input[data-validation-engine-skip], input[class*='validate-skip']", a._submitButtonClick),
            t.removeData("jqv_submitButton"),
            r.autoPositionUpdate && e(window).off("resize", a.updatePromptsPosition),
            this
        },
        validate: function() {
            var t = e(this)
        ...
        showPrompt: function(e, t, r, i) {
            var o = this.closest("form, .validationEngineContainer")
              , s = o.data("jqv");
            return s || (s = a._saveOptions(this, s)),
            r && (s.promptPosition = r),
            s.showArrow = 1 == i,
            a._showPrompt(this, e, t, !1, s),
            this
        },
        hide: function() {
            var t, r = e(this).closest("form, .validationEngineContainer"), i = r.data("jqv"), o = i && i.fadeDuration ? i.fadeDuration : .3;
            return t = e(this).is("form") || e(this).hasClass("validationEngineContainer") ? "parentForm" + a._getClassName(e(this).attr("id")) : a._getClassName(e(this).attr("id")) + "formError",
            e("." + t).fadeTo(o, .3, function() {
                e(this).parent(".formErrorOuter").remove(),
                e(this).remove()
            }),
            this
        ...
        _onFieldEvent: function(t) {
            ...
            window.setTimeout(function() {
                a._validateField(r, o),
                0 == o.InvalidFields.length && o.onFieldSuccess ? o.onFieldSuccess() : o.InvalidFields.length > 0 && o.onFieldFailure && o.onFieldFailure()
        ...
        _onSubmitEvent: function() {
            ...
            return o && r.ajaxFormValidation ? (a._validateFormWithAjax(t, r),
            !1) : r.onValidationComplete ? !!r.onValidationComplete(t, o) : o
        },
        ...
        _validateFields: function(t) {
            ...
            if (t.find("[" + r.validateAttribute + "*=validate]").not(":disabled").each(function() {
                ...
                if (e.inArray(s.attr("name"), n) < 0) {
                    if (i |= a._validateField(s, r),
                    i && null == o && (s.is(":hidden") && r.prettySelect ? o = s = t.find("#" + r.usePrefix + a._jqSelector(s.attr("id")) + r.useSuffix) : (s.data("jqv-prompt-at")instanceof jQuery ? s = s.data("jqv-prompt-at") : s.data("jqv-prompt-at") && (s = e(s.data("jqv-prompt-at"))),
                    o = s)),
                        ...
                        for (var o = !1, s = 0; s < i.length; s++) {
                            ...
                            if (1 == u.length) {
                                ...
                                if (1 == l[1])
                                    if ("" != f && f) {
                                        if (r.allrules[f]) {
                                            var c = r.allrules[f].alertTextOk;
                                            c && (f = c)
                                        }
                                        r.showPrompts && a._showPrompt(u, f, "pass", !1, r, !0)
                                    } else
                                        a._closePrompt(u);
                                else {
                                    if (o |= !0,
                                    r.allrules[f]) {
                                        var c = r.allrules[f].alertText;
                                        c && (f = c)
                                    }
                                    r.showPrompts && a._showPrompt(u, f, "", !1, r, !0)
                                }
                            }
                        }
                        r.onAjaxFormComplete(!o, t, i, r)
                    } else
                        r.onAjaxFormComplete(!0, t, i, r)
                }
            })
        },
        _validateField: function(t, r, i) {
            if (t.attr("id") || (t.attr("id", "form-validation-field-" + e.validationEngine.fieldIdCounter),
            ++e.validationEngine.fieldIdCounter),
            !r.validateNonVisibleFields && (t.is(":hidden") && !r.prettySelect || t.parent().is(":hidden")))
                return !1;
            ...
            r.isError = !1,
            r.showArrow = !0,
            r.maxErrorsPerField > 0 && (p = !0);
            for (var m = e(t.closest("form, .validationEngineContainer")), g = 0; g < l.length; g++)
                l[g] = l[g].replace(" ", ""),
                "" === l[g] && delete l[g];
            for (var g = 0, h = 0; g < l.length; g++) {
                ...
                case "required":
                    v = !0,
                    x = a._getErrorMessage(m, t, l[g], l, g, r, a._required);
                    break;
                case "custom":
                ...
                case "groupRequired":
                    var C = "[" + r.validateAttribute + "*=" + l[g + 1] + "]"
                      , b = m.find(C).eq(0);
                    b[0] != t[0] && (a._validateField(b, r, i),
                    r.showArrow = !0),
                    x = a._getErrorMessage(m, t, l[g], l, g, r, a._groupRequired),
                    x && (v = !0),
                    r.showArrow = !1;
                    break;
                case "ajax":
                ...
                case "dateRange":
                    var C = "[" + r.validateAttribute + "*=" + l[g + 1] + "]";
                    r.firstOfGroup = m.find(C).eq(0),
                    r.secondOfGroup = m.find(C).eq(1),
                    (r.firstOfGroup[0].value || r.secondOfGroup[0].value) && (x = a._getErrorMessage(m, t, l[g], l, g, r, a._dateRange)),
                    x && (v = !0),
                    r.showArrow = !1;
                    break;
                case "dateTimeRange":
                    ...
                    r.firstOfGroup = m.find(C).eq(0),
                    r.secondOfGroup = m.find(C).eq(1),
                    (r.firstOfGroup[0].value || r.secondOfGroup[0].value) && (x = a._getErrorMessage(m, t, l[g], l, g, r, a._dateTimeRange)),
                    x && (v = !0),
                    r.showArrow = !1;
                    break;
                case "maxCheckbox":
                    t = e(m.find("input[name='" + u + "']")),
                    x = a._getErrorMessage(m, t, l[g], l, g, r, a._maxCheckbox);
                    break;
                case "minCheckbox":
                    t = e(m.find("input[name='" + u + "']")),
                    x = a._getErrorMessage(m, t, l[g], l, g, r, a._minCheckbox);
                    break;
                case "equals":
                ...
                case "creditCard":
                    ...
                    break;
                case "condRequired":
                    x = a._getErrorMessage(m, t, l[g], l, g, r, a._condRequired),
                    void 0 !== x && (v = !0);
                    break;
                case "validateFiles":
                    x = a._getErrorMessage(m, t, l[g], l, g, r, a._validateFiles);
                    break;
                case "sizeOfFile":
                    x = a._getErrorMessage(m, t, l[g], l, g, r, a._sizeOfFile)
                }
                var F = !1;
                if ("object" == typeof x)
                    switch (x.status) {
                ...
                if (F)
                    break;
                "string" == typeof x && (f += x + "<br/>",
                r.isError = !0,
                h++)
            }
            !v && !t.val() && t.val().length < 1 && l.indexOf("equals") < 0 && (r.isError = !1);
            var E = t.prop("type")
              , T = t.data("promptPosition") || r.promptPosition;
            ("radio" == E || "checkbox" == E) && m.find("input[name='" + u + "']").size() > 1 && (t = e("inline" === T ? m.find("input[name='" + u + "'][type!=hidden]:last") : m.find("input[name='" + u + "'][type!=hidden]:first")),
            r.showArrow = !1),
            t.is(":hidden") && r.prettySelect && (t = m.find("#" + r.usePrefix + a._jqSelector(t.attr("id")) + r.useSuffix)),
            r.isError && r.showPrompts ? a._showPrompt(t, f, c, !1, r) : d || a._closePrompt(t),
            d || t.trigger("jqv.field.result", [t, r.isError, f]);
            var w = e.inArray(t[0], r.InvalidFields);
            return w == -1 ? r.isError && r.InvalidFields.push(t[0]) : r.isError || r.InvalidFields.splice(w, 1),
            a._handleStatusCssClasses(t, r),
            r.isError && r.onFieldFailure && r.onFieldFailure(t),
            !r.isError && r.onFieldSuccess && r.onFieldSuccess(t),
            r.isError
        },
        _handleStatusCssClasses: function(e, a) {
            a.addSuccessCssClassToField && e.removeClass(a.addSuccessCssClassToField),
            a.addFailureCssClassToField && e.removeClass(a.addFailureCssClassToField),
            a.addSuccessCssClassToField && !a.isError && e.addClass(a.addSuccessCssClassToField),
            a.addFailureCssClassToField && a.isError && e.addClass(a.addFailureCssClassToField)
        },
        _getErrorMessage: function(t, r, i, o, s, n, l) {
            ...
            var f, c = i, v = r.attr("data-validation-engine") ? r.attr("data-validation-engine") : r.attr("class"), p = v.split(" ");
            if (f = "future" == i || "past" == i || "maxCheckbox" == i || "minCheckbox" == i ? l(t, r, o, s, n) : l(r, o, s, n),
            void 0 != f) {
                var m = a._getCustomErrorMessage(e(r), p, c, n);
                m && (f = m)
            }
            return f
        },
        _getCustomErrorMessage: function(e, t, r, i) {
            ...
            if (void 0 != s && (o = e.attr("data-errormessage-" + s),
            void 0 != o))
                return o;
            if (o = e.attr("data-errormessage"),
            void 0 != o)
                return o;
            var n = "#" + e.attr("id");
            if ("undefined" != typeof i.custom_error_messages[n] && "undefined" != typeof i.custom_error_messages[n][r])
            ...
            return o || "undefined" == typeof i.custom_error_messages[r] || "undefined" == typeof i.custom_error_messages[r].message || (o = i.custom_error_messages[r].message),
            o
        },
        _validityProp: {
        ...
        _required: function(a, t, r, i, o) {
            ...
            case "checkbox":
                if (o) {
                    if (!a.attr("checked"))
                        return i.allrules[t[r]].alertTextCheckboxMultiple;
                    break
                }
                var d = a.closest("form, .validationEngineContainer")
                  , u = a.attr("name");
                if (0 == d.find("input[name='" + u + "']:checked").size())
                    return 1 == d.find("input[name='" + u + "']:visible").size() ? i.allrules[t[r]].alertTextCheckboxe : i.allrules[t[r]].alertTextCheckboxMultiple
            }
        },
        _groupRequired: function(t, r, i, o) {
            var s = "[" + o.validateAttribute + "*=" + r[i + 1] + "]"
              , n = !1;
            if (t.closest("form, .validationEngineContainer").find(s).each(function() {
                if (!a._required(e(this), r, i, o))
                    return n = !0,
                    !1
            }),
            !n)
        ...
        _past: function(t, r, i, o, s) {
            var n, l = i[o + 1], d = e(t.find("*[name='" + l.replace(/^#+/, "") + "']"));
            ...
            if (u > n) {
                var f = s.allrules.past;
                return f.alertText2 ? f.alertText + a._dateToString(n) + f.alertText2 : f.alertText + a._dateToString(n)
            }
        },
        ...
        _creditCard: function(e, a, t, r) {
            ...
            if (s >= 14 && s <= 16 && parseInt(o) > 0) {
                var n, l = 0, t = s - 1, d = 1, u = new String;
                do
                    n = parseInt(o.charAt(t)),
                    u += d++ % 2 == 0 ? 2 * n : n;
                while (--t >= 0);for (t = 0; t < u.length; t++)
                    l += parseInt(u.charAt(t));
                i = l % 10 == 0
            }
            if (!i)
                return r.allrules.creditCard.alertText
        },
        _validateFiles: function(a, t, r, i) {
            var o = e(a);
            if (!o)
                return !0;
            if (void 0 != o[0].files[0]) {
                var s = t[r + 1]
                  , n = new RegExp(s);
                if (!n.test(e(o).val().split(".").reverse()[0]))
                    return i.allrules.validateFiles.alertText
            }
        },
        _sizeOfFile: function(a, t, r, i) {
            var o = e(a);
            if (console.log(e(a)),
            ...
            if (!o)
                return !0;
            if (void 0 != o[0].files[0]) {
                var s = o[0].files[0].size / 1024
                  , n = Math.round(s / 1024 * 100) / 100;
                if (n > 20)
                    return i.allrules.sizeOfFile.alertText
            }
        },
        _ajax: function(t, r, i, o) {
            ...
            if ("object" == typeof l)
                ...
                for (var f = l.split("&"), i = 0; i < f.length; i++) {
                    var c = f[i].split("=");
                    c[0] && c[0] && (u[c[0]] = c[1])
                }
            if (d)
            ...
            if ("field" == o.eventTrigger && delete o.ajaxValidCache[t.attr("id")],
            !o.isError && !a._checkAjaxFieldStatus(t.attr("id"), o))
                return e.ajax({
                        ...
                        if (1 == s.length) {
                            ...
                            if (l) {
                                ...
                                d) {
                                    ...
                                    d = n.alertTextOk;
                                o.showPrompts && (d ? a._showPrompt(s, d, "pass", !0, o) : a._closePrompt(s)),
                                "submit" == o.eventTrigger && t.closest("form").submit()
                            } else {
        ...
        _parseDate: function(e) {
            var a = e.split("-");
            return a == e && (a = e.split("/")),
            a == e ? (a = e.split("."),
            new Date(a[2],a[1] - 1,a[0])) : new Date(a[0],a[1] - 1,a[2])
        },
        _showPrompt: function(t, r, i, o, s, n) {
            ...
            n && (l = !1),
            e.trim(r) && (l ? a._updatePrompt(t, l, r, i, o, s) : a._buildPrompt(t, r, i, o, s))
        },
        _buildPrompt: function(t, r, i, o, s) {
            var n = e("<div>");
            switch (n.addClass(a._getClassName(t.attr("id")) + "formError"),
            n.addClass("parentForm" + a._getClassName(t.closest("form, .validationEngineContainer").attr("id"))),
            ...
            o && n.addClass("ajaxed");
            var l = (e("<div>").addClass("formErrorContent").html(r).appendTo(n),
            t.data("promptPosition") || s.promptPosition);
            if (s.showArrow) {
                var d = e("<div>").addClass("formErrorArrow");
                if ("string" == typeof l) {
                    var u = l.indexOf(":");
                    u != -1 && (l = l.substring(0, u))
                }
                switch (l) {
                case "bottomLeft":
                case "bottomRight":
                    n.find(".formErrorContent").before(d),
                    d.addClass("formErrorArrowBottom").html('<div class="line1"><!-- --></div><div class="line2"><!-- --></div><div class="line3"><!-- --></div><div class="line4"><!-- --></div><div class="line5"><!-- --></div><div class="line6"><!-- --></div><div class="line7"><!-- --></div><div class="line8"><!-- --></div><div class="line9"><!-- --></div><div class="line10"><!-- --></div>');
                    break;
                case "topLeft":
                case "topRight":
                    d.html('<div class="line10"><!-- --></div><div class="line9"><!-- --></div><div class="line8"><!-- --></div><div class="line7"><!-- --></div><div class="line6"><!-- --></div><div class="line5"><!-- --></div><div class="line4"><!-- --></div><div class="line3"><!-- --></div><div class="line2"><!-- --></div><div class="line1"><!-- --></div>'),
                    n.append(d)
                }
            }
            s.addPromptClass && n.addClass(s.addPromptClass);
            var f = t.attr("data-required-class");
            if (void 0 !== f)
                n.addClass(f);
            else if (s.prettySelect && e("#" + t.attr("id")).next().is("select")) {
                var c = e("#" + t.attr("id").substr(s.usePrefix.length).substring(s.useSuffix.length)).attr("data-required-class");
            ...
            "undefined" != typeof t.attr("data-prompt-target") && e("#" + t.attr("data-prompt-target")).length > 0 ? n.appendTo(e("#" + t.attr("data-prompt-target"))) : t.after(n)) : t.before(n);
            ...
            s.autoHidePrompt && setTimeout(function() {
                n.animate({
                    ...
                    n.closest(".formErrorOuter").remove(),
                    n.remove()
                })
            }, s.autoHideDelay),
            n.animate({
        ...
        _updatePrompt: function(e, t, r, i, o, s, n) {
            if (t) {
                "undefined" != typeof i && ("pass" == i ? t.addClass("greenPopup") : t.removeClass("greenPopup"),
                "load" == i ? t.addClass("blackPopup") : t.removeClass("blackPopup")),
                o ? t.addClass("ajaxed") : t.removeClass("ajaxed"),
                t.find(".formErrorContent").html(r);
        ...
        _calculatePosition: function(e, a, t) {
            var r, i, o, s = e.width(), n = e.position().left, l = e.position().top, d = (e.height(),
            a.height());
            r = i = 0,
            o = -d;
            var u = e.data("promptPosition") || t.promptPosition
              ...
              , v = 0
              , p = 0;
            switch ("string" == typeof u && u.indexOf(":") != -1 && (f = u.substring(u.indexOf(":") + 1),
            u = u.substring(0, u.indexOf(":")),
            f.indexOf(",") != -1 && (c = f.substring(f.indexOf(",") + 1),
        ...
        _condRequired: function(e, t, r, i) {
            ...
            for (o = r + 1; o < t.length; o++)
                if (s = jQuery("#" + t[o]).first(),
                s.length && void 0 == a._required(s, ["required"], 0, i, !0))
                    return a._required(e, ["required"], 0, i)
        },
        _submitButtonClick: function(a) {
            var t = e(this)
              , r = t.closest("form, .validationEngineContainer");
            r.data("jqv_submitButton", t.attr("id"))
        }
    };
    e.fn.validationEngine = function(t) {
        var r = e(this);
        return r[0] ? "string" == typeof t && "_" != t.charAt(0) && a[t] ? ("showPrompt" != t && "hide" != t && "hideAll" != t && a.init.apply(r),
        a[t].apply(r, Array.prototype.slice.call(arguments, 1))) : "object" != typeof t && t ? void e.error("Method " + t + " does not exist in jQuery.validationEngine") : (a.init.apply(r, arguments),
        a.attach.apply(r)) : r
    }
    ,
    e.validationEngine = {
