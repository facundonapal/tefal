!function(e, t, n) {
    ...
    e.migrateMute = !1,
    e.migrateTrace = !1,
    e.migrateTrace && !e.migrateMute && t.console && t.console.log && t.console.log("JQMIGRATE: Logging is active"),
    ...
    e.attr = function(t, a, i, u) {
        ...
        t && !l.test(h) && (o ? a in o : e.isFunction(e.fn[a]))) ? e(t)[a](i) : ("type" === a && i !== n && d.test(t.nodeName) && t.parentNode && r("Can't change the 'type' of an input or button in IE 6/7/8"),
        ...
        a)
            for (u = function(e) {
                if (!e.type || w.test(e.type))
                    return i ? i.push(e.parentNode ? e.parentNode.removeChild(e) : e) : a.appendChild(e)
            }
            ,
            o = 0; null != (s = d[o]); o++)
                ...
                d.splice.apply(d, [o + 1, 0].concat(c)),
                o += c.length));
        return d
    }
    );
    ...
    e.fn.live = function(t, n, a) {
        ...
        N ? N.apply(this, arguments) : (e(this.context).on(t, this.selector, n, a),
        this)
    }
    ,
