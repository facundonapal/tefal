        ...
        function r(t) {
            ...
            t && "object" == typeof t && t.nodeType) {
                ...
                var g = r.paddingLeft + r.paddingRight
                  ...
                  , E = s && f
                  , x = i(e.width);
                x !== !1 && (r.width = x + (E ? 0 : g + z));
                var b = i(e.height);
                return b !== !1 && (r.height = b + (E ? 0 : v + L)),
...
function(t, e) {
    ...
    s.prototype.getPosition = function() {
        var t = p(this.element)
          ...
          , a = parseInt(r, 10)
          , u = this.layout.size;
        s = -1 != n.indexOf("%") ? s / 100 * u.width : s,
        a = -1 != r.indexOf("%") ? a / 100 * u.height : a,
        s = isNaN(s) ? 0 : s,
        a = isNaN(a) ? 0 : a,
        s -= i ? u.paddingLeft : u.paddingRight,
        a -= o ? u.paddingTop : u.paddingBottom,
        this.position.x = s,
        this.position.y = a
    }
    ,
    ...
    s.prototype.getTranslate = function(t, e) {
        ...
        t = this.getXValue(t),
        e = this.getYValue(e),
        d ? "translate3d(" + t + ", " + e + ", 0)" : "translate(" + t + ", " + e + ")"
    }
    ,
    ...
    ,
    s.prototype.moveTo = l ? s.prototype._transitionTo : s.prototype.goTo,
    ...
    ,
    s.prototype.transition = s.prototype[h ? "_transition" : "_nonTransition"],
